...
<head>
    ...
    <title>智慧校园-基于GIS的视频监控系统-超级用户管理员主页</title>
    ...
    <div class="container-fluid ">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li ><a class="time">超级管理员${sessionScope.rmark}您好</a> </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu xu" >
                        ...
                        <li><a href="manage.html?username=${sessionScope.rmark}">用户管理</a></li>
...
<div class="content">
    <div class="content-left">
        <form action="#" method="post"  name="TForm"  target="n_iframe" style="height: 60%;">
            <div class="content-left-top">
                <p class="content-left-top-title">监控点位建筑信息</p>
                <div>
                    <h3 id="title" class="name" ></h3>
                    <div class="image">
                        <img id="myimg" src="">
                    </div>
        ...
        <iframe id="id_iframe" name="n_iframe" style="display:none;" href="findimg.action"></iframe><!--//设置name="TForm"的表单提交但不跳转 -->

        <form action="movie.action" method="post"  name="form"  style="height: 50%;" >
            <div class="content-left-bottom">
                <p class="content-left-bottom-title">该建筑监控列表显示</p>
                <div id="light" class=".content-left-bottom-text" >
                    <ul id="s" >
                        <li></li>
                        <li></li>
                        <li></li>
