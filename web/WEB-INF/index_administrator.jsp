...
<head>
    ...
    <title>智慧校园-基于GIS的视频监控系统—管理员主页</title>
    ...
    <div class="container-fluid ">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li ><a class="time">管理员${sessionScope.rmark}您好</a> </li>
                <li class="dropdown">
...
<div class="content">
    <div class="content-left">
        ...
        <iframe id="id_iframe" name="n_iframe" style="display:none;"  href="findpic.action"></iframe><!--//设置表单提交但不跳转-->
