...
define('Plot/Leaflet/GetLibInfoParameter', function() {
    return Cesium['GetLibInfoParameter'];
});

define('Plot/Leaflet/GetSymbolInfoParameters', function() {
    return Cesium['GetSymbolInfoParameters'];
});
